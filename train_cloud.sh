...
set +e
python3 scripts/train2.py --num_consider 100 --batch_size 16 --num_data 320 --ckpt_every 20 --num_epochs 1
python3 scripts/train2.py --num_consider 1000 --batch_size 16 --num_data 1280 --ckpt_every 20 --num_epochs 2
